...
namespace BloodSword::Test
{
    void Controls(Graphics::Base &graphics)
    {
        if (graphics.Renderer)
        {
            ...
            auto enchanter_text = Graphics::CreateText(graphics, "Forget the mundane arts of swordplay. You know that true power lies in the manipulation of occult powers of sorcery.", Fonts::Normal, {255, 255, 255, 255}, TTF_STYLE_NORMAL, 8 * ws - s);
